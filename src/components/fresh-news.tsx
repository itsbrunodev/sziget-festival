...
export function FreshNews() {
  return (
    <div className="flex w-full flex-col items-center bg-primary-100 pb-12">
      ...
      <div className="flex w-full max-w-content flex-col items-center justify-between gap-6 px-4 pt-12 sm:flex-row sm:px-0">
        <h2 className="text-3xl font-black text-zinc-800">GET FRESH NEWS</h2>
        <div className="relative w-96">
          <input
            className="full border-b-2 border-b-zinc-400 bg-transparent py-2 font-light text-zinc-700 outline-none transition-colors placeholder:text-zinc-400"
            type="text"
